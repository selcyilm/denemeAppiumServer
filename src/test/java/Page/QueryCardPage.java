...
import utilities.AndroidDriverManager;
...
public class QueryCardPage {
   public QueryCardPage(){
       ...
       PageFactory.initElements(new AppiumFieldDecorator(AndroidDriverManager.getDriver()),this);
    ...
    public  void Login (String phoneNumber,String password){
        ...
        Actions actions = new Actions(AndroidDriverManager.getDriver());
